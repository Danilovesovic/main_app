...
); // .single znaci da očekujemo jedan fajl oznacen sa name="profileImage" iz inputa forme
...
router.post(
  "/social",
  uploadPostMedia.fields([{ name: "images", maxCount: 10 }]),
...
router.patch(
  "/superadmin/update-permission/:userId",
  SuperadminController.updatePermission,
);

//notice routes nikola
router.use("/notices", require("./notice-routes.js"));
